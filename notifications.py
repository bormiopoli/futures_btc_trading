...
def generate_notification(gmail_service, dataframefun, bodies, i=0):
    message = f"Bi-LSTM 1d TDX: EXECUTION {i}: This is the structure for the last strategy deployment:\n\n{bodies}"
    attachments=None
...
def send_message(service, user_id, message):
  ...
  try:
    ...
    print (f'ST ASSETS 1h - An error occurred in sending message: {error}')
